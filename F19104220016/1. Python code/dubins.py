...
def dubins_path_planning(sx, sy, syaw, ex, ey, eyaw, c, D_ANGLE=np.deg2rad(10.0)):
    ...
    mode, clen, D = dubins_path_planning_from_origin(
...
def main():
    ...
    px, py, pyaw, mode, clen, _ = dubins_path_planning(start_x, start_y, start_yaw,
...
def test():
    ...
    for i in range(NTEST):
        ...
        mode, clen, dis = dubins_path_planning(
